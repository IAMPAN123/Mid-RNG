...
class Inventory:
    ...
    def load_item_images(self):
        ...
        item_images = [
            pygame.image.load('Images/item_image/commonitem.png').convert_alpha(),                    
            pygame.image.load('Images/item_image/uncommonitem.png').convert_alpha(),
            pygame.image.load('Images/item_image/rareitem.png').convert_alpha(),
            pygame.image.load('Images/item_image/epicitem.png').convert_alpha(),
            pygame.image.load('Images/item_image/legendaryitem.png').convert_alpha(),
            pygame.image.load('Images/item_image/mythicitem.png').convert_alpha(),
            pygame.image.load('Images/item_image/frauditem.png').convert_alpha(),
            pygame.image.load('Images/item_image/wormitem.png').convert_alpha(),
            pygame.image.load('Images/item_image/judgeitem.png').convert_alpha(),
            pygame.image.load('Images/item_image/gambleritem.png').convert_alpha(),
            pygame.image.load('Images/item_image/babyitem.png').convert_alpha(),
            pygame.image.load('Images/item_image/comedianitem.png').convert_alpha(),
            pygame.image.load('Images/item_image/farmeritem.png').convert_alpha(),
            pygame.image.load('Images/item_image/catitem.png').convert_alpha(),
            pygame.image.load('Images/item_image/freakyitem.png').convert_alpha(),
            pygame.image.load('Images/item_image/misogynistitem.png').convert_alpha(),
            pygame.image.load('Images/item_image/specialzitem.png').convert_alpha(),
            pygame.image.load('Images/item_image/nahitem.png').convert_alpha(),
            pygame.image.load('Images/item_image/voiditem.png').convert_alpha(),
            pygame.image.load('Images/item_image/malevolentitem.png').convert_alpha(),
            pygame.image.load('Images/equipment_image/fingerequip.png').convert_alpha(),                    
            pygame.image.load('Images/equipment_image/babyrattleequip.png').convert_alpha(),
            pygame.image.load('Images/equipment_image/isohequip.png').convert_alpha(),
            pygame.image.load('Images/equipment_image/jailworldequip.png').convert_alpha(),
            pygame.image.load('Images/equipment_image/sex()eyesequip.png').convert_alpha(),
